...
class ZipInfo (object):
    ...
    def __init__(self, filename="NoName", date_time=(1980,1,1,0,0,0)):
        ...
        self.filename = filename.encode('utf-8')        # Normalized file name
        ...
        self.flag_bits = 0x808          # ZIP flag bits, bit 3 indicates presence of data descriptor
...
class ZipStream:
    ...
    def __init__(self, path, arc_path='', compression=ZIP_DEFLATED):
        ...
        self.path = unicode(path)           # source path
        self.arc_path = unicode(arc_path)   # top level path in archive
